...
I have built a web application to analyze Mirantis Kubernetes Engine (MKE) support dumps. The app allows you to upload a .tar.gz dump, parses the logs, and provides a root cause analysis report.
